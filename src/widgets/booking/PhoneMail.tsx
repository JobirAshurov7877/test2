...
const PhoneMail = () => {
  ...
  /* /// INPUTS FOCUSED STATES END /// */
  /* /// INPUTS FOCUSED STATES END /// */
  /* /// INPUTS FOCUSED STATES END /// */

  /* /// VERIFY NUMBER STATES /// */
  /* /// VERIFY NUMBER STATES /// */
  /* /// VERIFY NUMBER STATES /// */
  ...
  const handleRegister = async () => {
    ...
    const orderResponse = await Axios.post("/api/auth-and-order", {
    ...
    if (orderResponse.data === 200) {
      const formValues: FormData = {
        ...
        email: emailValue,
        tel: {
          recipient: phoneValue.recipient, // Pass recipient as part of PhoneState
          countryCode: phoneValue.countryCode, // Include countryCode if needed
        },
      };
      ...
      setLoading(false);
      navigate(`/${currentLanguage}/services/booking-process/subservice/error`);
    }
  };
  /* REGISTER END */
  /* REGISTER END */
